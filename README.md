...
[![Latest Release](https://img.shields.io/github/release-date/oe-alliance-plugins/AutomaticVolumeAdjustment?label=From&color=darkviolet)](https://github.com/oe-alliance-plugins/AutomaticVolumeAdjustment/releases/latest)
...
AutomaticVolumeAdjustment is created by users for users and we welcome every contribution. There are no highly paid developers. There are only users who have seen a problem and done their best to fix it. This means AutomaticVolumeAdjustment will always need the contributions of users like you. How can you get involved?
